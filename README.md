...
| `CARRIER` | Odd minutes, 10–60 s | Steady carrier, the best power measurement window |
...
With `REPORT = True` and a valid `GRIDSQUARE` set, `beacon_monitor.py` handles collecting, CSV logging, and uploading to the NTMS API, all in one process:
...
R820T2 / R828D gain steps (dB): `0 0.9 1.4 2.7 3.7 7.7 8.7 12.5 14.4 15.7 16.6 19.7 20.7 22.9 25.4 28.0 29.7 32.8 33.8 36.4 37.2 38.6 40.2 42.1 43.4 43.9 44.5 48.0 49.6`. A good starting point for 10 GHz beacon work is typically 28–38 dB.
